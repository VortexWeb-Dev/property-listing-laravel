    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                options: [
                    { value: "AP", label: "Apartment / Flat" },
                    { value: "TH", label: "Townhouse" },
                    { value: "VH", label: "Villa / House" },
                    { value: "PH", label: "Penthouse" },
                    { value: "LP", label: "Residential Land" },
                    ...
                    // { value: "FA", label: "Farm" },
                    { value: "HA", label: "Hotel Apartment" },
                    { value: "HF", label: "Half Floor" },
                    { value: "LC", label: "Labor Camp" },
                    // { value: "LP", label: "Land / Plot" },
                    { value: "OF", label: "Office Space" },
                    // { value: "OF", label: "Business Centre" },
                    { value: "RE", label: "Retail" },
                    // { value: "RE", label: "Restaurant" },
                    { value: "SA", label: "Staff Accommodation" },
                    { value: "WB", label: "Whole Building" },
                    { value: "SH", label: "Shop" },
                    { value: "SR", label: "Show Room" },
                    // { value: "OF", label: "Co-working Space" },
                    { value: "WH", label: "Storage" },
                    // { value: "WH", label: "Warehouse" },
                    // { value: "LP", label: "Commercial Land" },
                    // { value: "FF", label: "Commercial Floor" },
                    // { value: "WB", label: "Commercial Building" },
                    // { value: "FF", label: "Residential Floor" },
                ],
                required: true,
            },
            {
